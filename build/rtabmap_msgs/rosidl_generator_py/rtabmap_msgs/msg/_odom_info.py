...
class OdomInfo(metaclass=Metaclass_OdomInfo):
    ...
    __slots__ = [
        ...
        '_local_bundle_time',
        '_local_bundle_avg_inlier_distance',
        '_local_bundle_max_key_frames_for_inlier',
        '_key_frame_added',
        '_time_estimation',
    ...
    _fields_and_field_types = {
        ...
        'local_bundle_avg_inlier_distance': 'float',
        'local_bundle_max_key_frames_for_inlier': 'int32',
    ...
    def __init__(self, **kwargs):
        ...
        self.local_bundle_avg_inlier_distance = kwargs.get('local_bundle_avg_inlier_distance', float())
        self.local_bundle_max_key_frames_for_inlier = kwargs.get('local_bundle_max_key_frames_for_inlier', int())
    ...
    def __eq__(self, other):
        ...
        if self.local_bundle_time != other.local_bundle_time:
            return False
        if self.local_bundle_avg_inlier_distance != other.local_bundle_avg_inlier_distance:
            return False
        if self.local_bundle_max_key_frames_for_inlier != other.local_bundle_max_key_frames_for_inlier:
            return False
    ...
    @builtins.property
    def local_bundle_avg_inlier_distance(self):
        """Message field 'local_bundle_avg_inlier_distance'."""
        return self._local_bundle_avg_inlier_distance

    @local_bundle_avg_inlier_distance.setter
    def local_bundle_avg_inlier_distance(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'local_bundle_avg_inlier_distance' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'local_bundle_avg_inlier_distance' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._local_bundle_avg_inlier_distance = value

    @builtins.property
    def local_bundle_max_key_frames_for_inlier(self):
        """Message field 'local_bundle_max_key_frames_for_inlier'."""
        return self._local_bundle_max_key_frames_for_inlier

    @local_bundle_max_key_frames_for_inlier.setter
    def local_bundle_max_key_frames_for_inlier(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'local_bundle_max_key_frames_for_inlier' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'local_bundle_max_key_frames_for_inlier' field must be an integer in [-2147483648, 2147483647]"
        self._local_bundle_max_key_frames_for_inlier = value
